...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <style>
        ...
        #search {
            ...
            width: 400px; /* Set a longer width for the search form */
        ...
        .form-check-label {
            margin-left: 10px; /* Space between radio inputs and labels */
        }
        ...
        .form-range {
            ...
            width: 100%;
            height: 8px;
            background: #007bff; /* Custom track color */
            border-radius: 5px;
        }
...
<section id="search">
    ...
    <form>
        ...
        <div class="form-group">
            <label class="font-weight-bold" for="keywords">Search</label>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    <section id="featured" class="my-5 py-5">
        ...
        <div class="product text-center col-lg-3 col-md-4 col-sm-12" style="margin-left: 20px; margin-right: 10px;">
                <img class="img-fluid mb-3"
                src="assets/css/js/imgs/shop14.jpeg"
                    alt="Product Image">
                <div class="star">
                ...
                <h5 class="p-name">Gibson 2019 LP CLassic Electric Guitar</h5>
                <h4 class="p-price">₱19000</h4>
            ...
            <div class="product text-center col-lg-3 col-md-4 col-sm-12" style="margin-left: 20px; margin-right: 10px;">                <img class="img-fluid mb-3"
                src="assets/css/js/imgs/shop15.jpeg"
                    alt="Product Image">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Fender American Ultra Stereocaster Electric Guitar</h5>
                <h4 class="p-price">₱16880</h4>
                <button class="btn btn-primary buy-btn">Buy Now</button>
            </div>
            <div class="product text-center col-lg-3 col-md-4 col-sm-12" style="margin-left: 20px; margin-right: 10px;">                <img class="img-fluid mb-3"
                src="assets/css/js/imgs/shop16.jpeg"
                    alt="Product Image">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Fender Modern Telecaster Electric Guitar with Maple Neck</h5>
                <h4 class="p-price">₱24599</h4>
                <button class="btn btn-primary buy-btn">Buy Now</button>
            </div>
            <div class="product text-center col-lg-3 col-md-4 col-sm-12" style="margin-left: 20px; margin-right: 10px;">                <img class="img-fluid mb-3"
                src="assets/css/js/imgs/shop10.jpeg" 
                alt="Product Image">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Ibanez GRGA120 Electric Guitar</h5>
                <h4 class="p-price">₱11000</h4>
                <button class="btn btn-primary buy-btn">Buy Now</button>
            </div>
            <div class="product text-center col-lg-3 col-md-4 col-sm-12" style="margin-left: 20px; margin-right: 10px;">                <img class="img-fluid mb-3"
                src="assets/css/js/imgs/shop11.jpeg"
                    alt="Product Image">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Ephiphone Hallowbody Electric Guitar</h5>
                <h4 class="p-price">₱28000</h4>
                <button class="btn btn-primary buy-btn">Buy Now</button>
            </div>
            <div class="product text-center col-lg-3 col-md-4 col-sm-12" style="margin-left: 20px; margin-right: 10px;">                <img class="img-fluid mb-3"
                src="assets/css/js/imgs/shop12.jpeg"
                    alt="Product Image">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Fender Stratocaster HSH Electric Guitar</h5>
                <h4 class="p-price">₱16599</h4>
                <button class="btn btn-primary buy-btn">Buy Now</button>
            </div>
            <div class="product text-center col-lg-3 col-md-4 col-sm-12" style="margin-left: 20px; margin-right: 10px;">                <img class="img-fluid mb-3"
                src="assets/css/js/imgs/accessories1.jpeg" 
                alt="Product Image">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="product text-center col-lg-3 col-md-4 col-sm-12" style="margin-left: 20px; margin-right: 10px;">                <img class="img-fluid mb-3"
                src="assets/css/js/imgs/accessories2.jpeg"
                    alt="Product Image">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="product text-center col-lg-3 col-md-4 col-sm-12" style="margin-left: 20px; margin-right: 10px;">                <img class="img-fluid mb-3"
                src="assets/css/js/imgs/accessories3.jpeg"
                    alt="Product Image">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
